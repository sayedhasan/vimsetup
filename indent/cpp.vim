...
function! SetupForCLang()
    ...
    " map! <F5> <Esc>:!python /nfs/pdx/disks/tcad_ptm_pdmg_work_07/ndm_pub/cpplint/cpplint.py %:p 2> lint.out<CR>:cfile lint.out<CR>:silent !rm lint.out<CR>:redraw!<CR>:cc<CR>
    " map  <F5> <Esc>:!python /nfs/pdx/disks/tcad_ptm_pdmg_work_07/ndm_pub/cpplint/cpplint.py %:p 2> lint.out<CR>:cfile lint.out<CR>:silent !rm lint.out<CR>:redraw!<CR>:cc<CR>
endfunction
