...
Plugin 'rakr/vim-one'
Plugin 'http://github.com/joshdick/onedark.vim.git'
Plugin 'rafi/awesome-vim-colorschemes'
Plugin 'mhartington/oceanic-next'
Plugin 'https://github.com/Mofiqul/vscode.nvim.git'
" Plugin 'vimcolorschemes/vimcolorschemes.git'
" Plugin 'hanviet/vim-monokai-pro.git'
" Plugin 'ray-x/aurora.git'
